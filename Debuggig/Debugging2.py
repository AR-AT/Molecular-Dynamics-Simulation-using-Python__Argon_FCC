...
def main():
    ...
    preliminary_temperatures = np.arange(60, 100, 5)  
    ...
    algorithm_names = ["Velocity-Verlet (Adaptive)",
                       ...
                       "Leapfrog Verlet (Adaptive)", "Beeman (Adaptive)"]
    ...
    sampling_step_range = [15000, 25000,40000,60000]
    ...
    generate_pdf_report("MD_Simulation_Report5(Beemans).pdf",
    melting_point, boiling_point, a_opt,
