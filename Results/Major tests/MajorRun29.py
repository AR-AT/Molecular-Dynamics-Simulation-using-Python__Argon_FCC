...
def adaptive_equilibration(positions, velocities, forces, dt, box_length,
                           verlet_algorithm, initial_equilibration_window=5000,
                           initial_threshold=1e-21, min_threshold=1e-24,
                           max_threshold=1e-19, max_steps=60000):
...
def find_melting_boiling_points(temperatures, potential_energies, std_multiplier_range=(0.0001, 0.001), window_size_ratio_range=(0.01, 0.3), step=0.03):
