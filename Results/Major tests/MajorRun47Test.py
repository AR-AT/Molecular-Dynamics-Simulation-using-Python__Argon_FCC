...
def adaptive_equilibration(positions, velocities, forces, dt, box_length,
                           ...
                           max_threshold=5e-21, max_steps=90000):
        ...
        while equilibration_steps < max_steps:
            ...
            if index >= window_size:
                ...
                if std_potential_energy > threshold:
                    threshold = min(threshold * 1.095, max_threshold)
                    new_window_size = min(int(window_size * 1.001), len(recent_potential_energies) * 1.001)
...
def main():
    ...
    preliminary_temperatures = np.arange(5, 205, 30)

    time_steps = [1e-14, 1e-15, 5e-16, 5e-15]
    ...
    sampling_step_range = [20000, 40000, 80000, 60000]
