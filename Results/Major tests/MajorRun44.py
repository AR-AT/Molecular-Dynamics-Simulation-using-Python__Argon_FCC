...
def main():
    ...
    max_ape = 0
    max_aed = 0
    small_value = 1e-30  # Small value to prevent division by zero
    ...
    w_aed = 0.5
    for sampling_steps in average_results:
        normalized_ape = average_results[sampling_steps]['average_potential_energy'] / (max_ape + small_value)
        normalized_aed = average_results[sampling_steps]['average_energy_drift'] / (max_aed + small_value)
