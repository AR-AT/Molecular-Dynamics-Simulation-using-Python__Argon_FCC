...
def adaptive_equilibration(positions, velocities, forces, dt, box_length,
                           verlet_algorithm, initial_equilibration_window=1500,
                           initial_threshold=5e-21, min_threshold=1e-23,
                           max_threshold=9e-20, max_steps=30000):
...
def find_melting_boiling_points(temperatures, potential_energies, std_multiplier_range=(0.00005, 0.0005), window_size_ratio_range=(0.01, 0.1), step=0.01):
