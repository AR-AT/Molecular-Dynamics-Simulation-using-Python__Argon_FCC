...
def main():
    ...
    for sampling_steps in average_results:
        ...
        max_ape = max(max_ape, average_results[sampling_steps]['average_potential_energy'])
        max_aed = max(max_aed, average_results[sampling_steps]['average_energy_drift'])

    # Calculate the combined score
    w_ape = 0.5
    w_aed = 0.6
    for sampling_steps in average_results:
        normalized_ape = average_results[sampling_steps]['average_potential_energy'] / max_ape
        normalized_aed = average_results[sampling_steps]['average_energy_drift'] / max_aed
